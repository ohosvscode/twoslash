...
import Bluetooth, { BLEFoundResponse, BluetoothDevice, StartBLEScanOptions, StopBLEScanOptions, SubscribeBLEFoundOptions } from '@system.bluetooth';
export { BLEFoundResponse, Bluetooth, BluetoothDevice, StartBLEScanOptions, StopBLEScanOptions, SubscribeBLEFoundOptions, a2dp, access, baseProfile, ble, bluetooth, bluetoothManager, cardEmulation, connectedTag, connection, constant, hfp, hid, map, nfcController, omapi, opp, pan, pbap, socket, tag, wearDetection, wifi, wifiManager, wifiManagerExt, wifiext };
